...
The sheets themselves are published, so that line can be checked rather than trusted: [the signed paper sheets](/research/petition-signatures-redacted.pdf) (PDF, 21 pages). Street addresses are painted out; names, signatures, town, ZIP, and the circulator who certified each page are as signed.
