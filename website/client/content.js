...
export const documents = [
  ...
  {id: 'agreement', file: '09-development-agreement.md', number: '09', short: 'Agreement', title: 'The signed agreement', question: 'What does the signed agreement actually commit?', tone: 'source', time: '8 min', seoTitle: 'The Signed Americus Data Center Development Agreement', seoDescription: 'The July 1, 2026 agreement between the Americus-Sumter Payroll Development Authority and Liberty GA USA LLC, clause by clause - 102 acres for $1, four phases, 150 jobs, and what it still leaves unwritten.'},
  {id: 'liberty', file: '10-liberty-data-centers.md', number: '10', short: 'Liberty', title: 'Liberty Data Centers', question: 'Who is the company behind the proposal?', tone: 'source', time: '8 min', seoTitle: 'Liberty Data Centers: What the Public Record Shows', seoDescription: 'The company proposing the Americus data center, from primary sources - a domain registered in January 2026, no officers published anywhere, and a Toronto investor whose principals presented for Liberty in Americus on August 4.'},
